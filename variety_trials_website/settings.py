...
DATABASES = {
    'default': {
        ...
        'NAME': 'varieties',                      # Or path to database file if using sqlite3.
        'USER': 'varieties',                      # Not used with sqlite3.
        'PASSWORD': 'tyarbEc2',                  # Not used with sqlite3.
...
SECRET_KEY = '%g5w6pw5hr6w+#v$-3^p0xs4^4x&lb20g93qo42$o5jrl$z#-n'
