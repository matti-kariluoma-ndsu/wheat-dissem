...
class Trial_Entry(models.Model):
	...
	lsd_05               = models.DecimalField(decimal_places=5, max_digits=10, blank=True, null=True, help_text='LSD at a=0.05 (for the entire location in this year)')
	lsd_10               = models.DecimalField(decimal_places=5, max_digits=10, blank=True, null=True, help_text='LSD at a=0.10 (for the entire location in this year)')
	hsd_10               = models.DecimalField(decimal_places=5, max_digits=10, blank=True, null=True, help_text='HSD at a=0.05 (for the entire location in this year)')
